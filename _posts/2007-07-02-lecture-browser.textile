...
abstract: Enhancing the tele-TASK platform with the functionality to search the content of multimedia data and to annotate the recorded lectures.
---
...
The goal of the project was to extend and enhance the tele-TASK platform with respect to the integration of semantic web technologies into the system and thus giving the user further possibilities for the purposeful search in multimedia data. The semantic data for the videos were generated with the help of OCR data and the extracted voice of the speaker. Moreover that the project developed a tool to create time-related notes for the recorded lectures.
